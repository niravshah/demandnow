 ...
 */
public class AllJobsRecyclerAdapter extends RecyclerView.Adapter<AllJobsRecyclerAdapter.ViewHolder> {

    private List<JobInfo> mItems;
    private Context context;
    public AllJobsRecyclerAdapter(Context ctx, List<JobInfo> items) {
